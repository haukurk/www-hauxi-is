...
import { SendMessageFunc } from '../../../state/ducks/message/actions'
    ...
    return (
      <Container className="contactRow" text={true}>
        ...
        <Form className="contactForm" size="tiny" inverted={true} error={true}>
            ...
            />
            <Form.Field control={Button} onClick={() => this.props.sendMessage(this.state.name, this.state.phone, this.state.email, this.state.message)}>Send me this awesome message</Form.Field>
        </Form>
      </Container>
    );
  }
